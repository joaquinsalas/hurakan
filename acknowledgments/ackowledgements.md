...
The **Hurakán** project has been developed by a multidisciplinary team focused on the detection, tracking, and analysis of tropical cyclones using diffusion models, machine learning, and geospatial processing techniques.
...
| **Vawn Olvera** | Exploration of *downscaling* solutions for precipitation and construction of image datasets for analysis. |
| **Luis Ortiz** | Exploration of *downscaling* solutions for wind speed and construction of image datasets for analysis. |
| **Alejandro Gómez** | Monitoring of the activity schedule and fulfillment of deliverables. |
